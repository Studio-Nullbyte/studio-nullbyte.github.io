              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                {filteredProducts.map((product, index) => (
                  <motion.div
                    ...
                    className={`bg-code-gray-light border rounded-lg overflow-hidden hover:border-electric-violet/50 transition-colors ${!product.active ? 'opacity-60' : ''
                      }`}
                  >
                    {/* Product Image */}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex space-x-4">
                      <button
                        ...
                        className={`px-4 py-2 rounded font-mono text-sm transition-colors ${imageUploadMode === 'upload'
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded font-mono text-sm transition-colors ${imageUploadMode === 'url'
                            ? 'bg-electric-violet text-white'
                            : 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                          }`}
                      >
